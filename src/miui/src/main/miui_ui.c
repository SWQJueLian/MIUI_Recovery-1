...
STATUS miui_langmenu(char *title_name, char *title_icon) {
  ...
  //-- Populate Checkbox Items
  acsdmenu_add(menu1, "简体中文", "欢迎使用MIUI Recovery by Juelian \nwww.gaojiquan.com", "@lang.cn");
  acsdmenu_add(menu1, "English", "Welcome to MIUI Recovery by Juelian \nwww.gaojiquan.com", "@lang.en");
